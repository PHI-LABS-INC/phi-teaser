...
const defaultTransformCva = cva({
  variants: {
    artworkKey: {
      ...
      "crowd-front": { transform: defaultTransform({ x: -0.25, y: -8.125 }) },
      ...
      wawa: { transform: defaultTransform({ x: 10, y: -19.75 }) },
      "ethereum-space-station": { transform: defaultTransform({ x: -6.75, y: -16.25 }, "rotate(-15deg)") },
      "gnosis-owl": { transform: defaultTransform({ x: 11, y: 15.25 }) },
      "ds-planet": { transform: defaultTransform({ x: 10.125, y: -12.5 }) },
      "arb-game": { transform: defaultTransform({ x: 16, y: 5.25 }, "rotate(19deg)") },
      "op-game": { transform: defaultTransform({ x: 10.25, y: -0.5 }, "rotate(19deg)") },
      ...
      "op-airdrop": { transform: defaultTransform({ x: 17.75, y: -16 }) },
      ...
      legit: { transform: defaultTransform({ x: 0, y: -16.5 }, "rotate(-19deg)") },
      bull: { transform: defaultTransform({ x: 18.5, y: -21.125 }) },
    },
  },
});
        ...
        cva({
          variants: {
            artworkKey: {
              ...
              verifier: { transform: defaultTransform({ x: -14, y: -22.5 }) },
              artist: { transform: defaultTransform({ x: -24, y: -0.25 }) },
              "bounding-box": { transform: defaultTransform({ x: 1, y: 0 }) },
            },
          },
        })({ artworkKey }),
        css({
