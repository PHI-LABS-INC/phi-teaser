...
const defaultTransformCva = cva({
  variants: {
    artworkKey: {
      ...
      "crowd-front": { transform: defaultTransform({ x: -0.25, y: -8.25 }) },
      ...
      "ds-planet": { transform: defaultTransform({ x: 10, y: -13 }) },
      ...
      "op-airdrop": { transform: defaultTransform({ x: 10, y: -24 }) },
      ...
      bull: { transform: defaultTransform({ x: 18.5, y: -20.5 }) },
    },
  },
});
