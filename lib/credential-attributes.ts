...
export const credentialAttributes: Record<ArtworkKey, { title: string; requirement: string; url: string; description?: string }> = {
  "chess-uniswap": {
    ...
    description: "Uniswap is a decentralized trading platform enabling cryptocurrency trades. This award is granted to users who perform their first swap using Arbitrum on Uniswap V3. It provides a user-friendly interface and utilizes smart contracts for a fast and efficient trading experience.",
    url: "https://uniswap.org/",
  },
  "crowd-front": {
    title: "Governance Voter",
    requirement: "Participate in at least one governance vote on the Arbitrum Govenance",
    description: "This achievement acknowledges the active participation of users in the democratic process of the Arbitrum network by casting a vote in at least one governance decision. It highlights the user's commitment to shaping the future and contributing to the governance of the Arbitrum ecosystem through informed voting on Tally.",
  ...
  gitcoin: {
    ...
    description: "This sticker is awarded to users who have demonstrated a significant level of trust and reputation within the Gitcoin community by achieving a score of 20 or more on their Gitcoin Passport. The Passport uses a decentralized approach to verify digital identities, enabling users to participate in a more secure and authentic online ecosystem. By reaching a score of 20, it shows active and trustworthy participation in the Gitcoin network.",
    url: "https://passport.gitcoin.co/",
  },
  "op-airdrop": {
    title: "OP Airdrop 1 Recipient",
    requirement: "Receive tokens from Optimism's first airdrop",
    description: "This sticker is awarded to individuals who were recipients of Optimism’s first airdrop, recognizing their early involvement and positive contribution to the Optimism network. The first airdrop was a pivotal moment in Optimism's journey, aimed at rewarding users who actively contributed to the ecosystem’s growth.",
    url: "https://op.com/",
  },
  "ethereum-first-tx-date": {
    title: "Ethereum 20XX",
    requirement: "Date of your first transaction on Ethereum",
    description: "This sticker celebrates your first step into Ethereum. It's about the date when you made your first Ethereum transaction. This date marks when you started exploring the world of Ethereum, a key moment in your crypto journey. It's a special reminder of your beginnings in blockchain and a symbol of how far you've come.",
    url: "https://etherscan.io/",
  },
  "shib-profit": {
    title: "$SHIB HODLer",
    requirement: "All-time profit of $SHIB",
    description: "This sticker is for those who've experienced profit from holding Shiba Inu ($SHIB). It's a badge of honor for investors who believed in $SHIB and saw returns. Whether you joined early or recently, this sticker represents your smart investment choice and your journey in the world of meme coins. It's a fun way to celebrate your success with $SHIB.",
    url: "https://coinmarketcap.com/currencies/shiba-inu/",
  },
  "farcaster-ink": {
    title: "Farcaster Ink",
    requirement: "Cast once on Warpcast",
    description: "This sticker celebrates your first 'cast' on Warpcast within the Farcaster network. It’s a milestone for those who have taken the step to engage in this decentralized social media platform, where users connect, share ideas, and build community in the blockchain space. Whether it’s a thought, an observation, or a creative expression, your first cast is a significant moment in exploring and contributing to the vibrant world of decentralized communication",
